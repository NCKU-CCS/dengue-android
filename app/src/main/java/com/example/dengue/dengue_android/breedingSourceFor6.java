...
public class breedingSourceFor6 extends Fragment
    ...
    private static final String TAG = "dangue";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.take_photo_6, container, false);
    }
    ...
    private void unlockFocus() {
        try {
            ...
            mCaptureSession.setRepeatingRequest(mPreviewRequest, mCaptureCallback,
                    mBackgroundHandler);
            ((BreedingSourceSeparator)getActivity()).getImg(mFile.toString(),rotate);
